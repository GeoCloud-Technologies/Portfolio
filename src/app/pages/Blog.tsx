      ...
      <div className="max-w-xl w-full text-center relative z-10 space-y-8">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            The GeoCloud <span className="bg-gradient-to-r from-[#00d9ff] to-[#00ffea] bg-clip-text text-transparent">Blog</span>
          </h1>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-400 text-xs font-semibold uppercase tracking-wider">
            ...
            <span>Tech Insights & Analysis</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed font-light">
            We are preparing our digital publication platform. Soon, we will publish engineering analyses, tech trends, AI implementation guides and hardware maintenance insights.
          </p>
          <div className="mt-6 pt-6 border-t border-white/5 text-sm text-gray-400">
            Our platform is currently empty, but we will start publishing content soon.
          </div>
        </motion.div>
