...
export function Careers() {
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-white pt-24 pb-16 px-6 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[800px] h-[600px] bg-[#00d9ff]/5 blur-[140px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-xl w-full text-center relative z-10 space-y-8">
        ...
        <motion.div
          ...
          className="space-y-6"
        >
          <div className="inline-flex p-5 rounded-3xl bg-[#00d9ff]/10 border border-[#00d9ff]/20 text-[#00d9ff] mb-4">
            <Briefcase className="w-10 h-10" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Careers at <span className="bg-gradient-to-r from-[#00d9ff] to-[#00ffea] bg-clip-text text-transparent">GeoCloud Technologies</span>
          </h1>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-400 text-xs font-semibold uppercase tracking-wider">
            <Sparkles className="w-3.5 h-3.5 text-[#00ffea]" />
            <span>Talent Pipeline Incoming</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed font-light">
            While we do not have open roles right now, we are always eager to connect with forward-thinking builders, designers and innovators.
          </p>
          <div className="mt-6 pt-6 border-t border-white/5 text-sm text-gray-400">
            Check back soon or send your speculative CV to <span className="text-[#00d9ff]">geocloudtechnologies@gmail.com</span>
          </div>
        </motion.div>
